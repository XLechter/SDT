...
def data_setup(args, log_train):
    ...
    dataset_test = eval(args.dataset)(train=False, npoints=args.num_points, use_mean_feature=args.use_mean_feature, datapath=args.datapath)
...
def val(args, net, epoch, dataloader_test, log_train, best_val_losses, best_val_epochs, val_losses):
    ...
    with torch.no_grad():
        for i, data in enumerate(dataloader_test):
            ...
            _, _, _, emd2, _, cd_p2, _, cd_t2, _, _, _, origin_cd2 = net(inputs, gt.contiguous(), 0.004, 3000)
        ...
        return best_val_losses, best_val_epochs, save_cd_p, save_cd_t
